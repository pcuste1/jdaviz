...
class AID:
    ...
    def _get_current_projection(self):
        """
        Default orientation is generated by jdaviz with FITS WCS.
        The value of ctype[0] is expected to be "RA---TAN" or similar, so 5-8
        gives you "TAN". The supported three letter projection codes available
        ...
        return self.viewer.state.reference_data.coords.wcs.ctype[0][5:8]
